package com.example.onlineshopappecommerce.Helper;
import java.io.File;
...
public class TinyDB {
    ...
    public ArrayList<PopularDomain> getListObject(String key){
    	...
    	ArrayList<PopularDomain> objects =  new ArrayList<PopularDomain>();

    	for(String jObjString : objStrings){
    		PopularDomain value  = gson.fromJson(jObjString,  PopularDomain.class);
    		objects.add(value);
    	}
    	return objects;
    }
...
//    }
    ...
    public void putListObject(String key, ArrayList<PopularDomain> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
